...
Haplo_Class_all_SI <- 
  ...
  mutate(Prop_NewMarker_weightedHe = N_heterologuous_weightedHe/N_eval_weightedHe,
         Classification= ifelse(Prop_NewMarker_weightedHe >=0.75, "Heterologous", "Homologous")) %>% 
  ...
  mutate(Prop_NewMarker_top8 = N_heterologuous_top8 / N_eval_top8,
         Consensus_top8 = ifelse(Prop_NewMarker_top8 >=0.75, "Heterologous", "Homologous")) %>% 
  ...
  mutate(Prop_NewMarker_top4 = N_heterologuous_top4 / N_eval_top4,
         Consensus_top4 = ifelse(Prop_NewMarker_top4 >=0.75, "Heterologous", "Homologous")) %>% 
...
ggplot(aes(x = Prop_het, fill=Classification)) + 
