...
```{r read peru data}
peru <- readRDS(here("intermediate_data", "peru_data_merged.rds"))
...
peru_pnh <- readRDS(here("intermediate_data", "peru_data_classification.rds"))
ibd_r_data <- readRDS(here("intermediate_data", "peru_all_meta.rds"))
ibd_rhat_data <- readRDS(here("intermediate_data", "peru_sig_meta.rds"))
```
