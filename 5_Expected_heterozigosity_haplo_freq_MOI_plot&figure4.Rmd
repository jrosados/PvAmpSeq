...
haplotypes_all_samples_SI<-
  ...
  ggplot(aes(x = sample, y = Frequency ,fill = Haplotype), col = 'black') +
  ...
  theme(legend.position ="none", axis.text.y = element_text(face = "plain", color="black", size = 4, angle = 0), axis.text.x = element_blank(), axis.ticks = element_blank(), 
...
haplotypes_all_samples_PE<-
  ...
  ggplot(aes(x = sample, y = frequency ,fill = haplotype), col = 'black') +
  geom_bar(position = "stack", stat = "identity")+ 
  ylab("") + xlab("Multiplicity of infection")+ ggtitle("Peru")+ scale_colour_manual(values = rainbow(101)) +
  theme_classic(base_size = 10) + 
  theme(legend.position ="none", axis.text.y = element_text(face = "plain", color="black", size = 4, angle = 0), axis.text.x = element_blank(), axis.ticks = element_blank(), 
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
r <- ggdraw() +
  ...
  draw_plot(Hap_freq_Chr09_SI_plot, x = 0.5, y = .728, width = .25, height = .13) +
  draw_plot(Hap_freq_Chr13_SI_plot, x = 0.5, y = .695, width = .25, height = .13) +
  ...
  draw_plot(Hap_freq_Chr09_PE_plot, x = .75, y = .662, width = .25, height = .13) +
  draw_plot(Hap_freq_Chr14_PE_plot, x = .75, y = .629, width = .25, height = .13) +
...
print(r)
ggsave("figs/figure4.tiff", units="cm", width=30, height=18, dpi=300, compression = 'lzw')
```
```{r echo=F, eval=F}
