...
```{r load data}
sols <- readRDS(here("intermediate_data", "sols_data_merged.rds"))
...
```{r read pnh data}
sols_pnh <- readRDS(here("intermediate_data", "sols_data_classification.rds"))
ibd_r_data <- readRDS(here("intermediate_data", "sols_all_meta.rds"))
ibd_rhat_data <- readRDS(here("intermediate_data", "sols_sig_meta.rds"))
```
